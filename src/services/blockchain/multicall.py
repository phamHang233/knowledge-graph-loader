...
from artifacts.abis.multicall_v3_abi import MULTICALL_V3_ABI
...
from src.utils.dict_utils import all_equal
...
class W3Multicall:
    ...
    class Call:
        ...
        def __init__(self, address, abi, fn_name, fn_paras=None, block_number: Union[int, str] = 'latest'):
